...
import (
	"GraduationProject/controllers/admin"
	"GraduationProject/controllers/common"
	"GraduationProject/controllers/home"
	"GraduationProject/controllers/installer"
	"GraduationProject/controllers/wechat"
...
func init() {
	...
	// 前台留言列表
	beego.Router("/messag" +
		"e.html", &home.MessageController{}, "get:Get")
	// 前台保存
